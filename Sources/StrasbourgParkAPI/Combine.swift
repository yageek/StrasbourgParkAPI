...
extension ParkingAPIClient {
    ...
    public func getLocation() -> Future<[StrasbourgParkAPI.LocationOpenData], ParkingAPIClientError> {
    ...
    public func getStatus() -> Future<[StrasbourgParkAPI.StatusOpenData], ParkingAPIClientError> {
